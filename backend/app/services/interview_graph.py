...
Turn-based flow for REST API:
  start_interview()  → opening question
  process_answer()   → follow-up question OR final scoring
"""
from typing import TypedDict, Optional, List
from langgraph.graph import StateGraph, END

from app.services.llm import llm_generate_question, llm_score_interview
...
def start_interview(chapter_title: str, chapter_context: str, pass_threshold: int) -> dict:
    ...
    return dict(_get_start_graph().invoke(initial))
