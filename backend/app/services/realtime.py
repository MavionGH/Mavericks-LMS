...
def build_interview_instructions(
    *,
    ...
    return (
        ...
        "genuine, correct answer. Instead, say exactly: 'I don't understand, please "
        "speak English.' and then repeat the exact question you were asking. Do not "
        "say anything else, do not evaluate their response, and do NOT call "
