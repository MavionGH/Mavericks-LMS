...
function StudentDashboard() {
  ...
  const MY_COURSES = [
    { id: "1", title: "JavaScript Fundamentals", progress: 25, currentChapter: "Ch 1: Variables & Data Types", status: "In progress", lastScore: 79, icon: "JS" },
    { id: "2", title: "React & Next.js Mastery",  progress: 0,  currentChapter: "Intro & Core Paradigms",      status: "Not started", lastScore: null, icon: "RX" },
  ];

  const RECENT_EVALUATIONS = [
    { chapter: "Variables & Data Types", course: "JavaScript Fundamentals", score: 79, passed: true, date: "2026-06-19", technical: 85, communication: 78, confidence: 72 },
  ];
